...
function page() {
  return (
    <React.Fragment>
      <Header />
      <div className=" bg-blue-200  shadow-xl flex justify-center items-center  shadow-blue-400  rounded-ee-xl rounded-es-xl text-2xl font-sans  "  >
        <h2 className="p-4" >خانه {"<"}  خدمات ما</h2>
      </div>
